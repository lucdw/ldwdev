...
#'
#' This function compares two text files and stores the differences in a typical .diff file
#'
#' @param infile1 a connection or a character vector of length 1 with the path to the first file
#' @param infile2 a connection or a character vector of length 1 with the path to the second file
#' @param outfile a connection or a character vector of length 1 with the path to the output file
#' @param remove.lines NULL or a character vector with strings identifying lines which should be excluded from comparison
#' @param equal.lines integer value > 1L, for number of lines to be a match, default is 2L
#'
...
#' outfil <- file()
#' writeLines(c("a", "b", "c", "d", "e", "f", "g", "h", "i", "j"), filenames[1])
#' writeLines(c("0", "1", "a", "b", "c", "e", "f", "grrr", "h", "i", "j"), filenames[2])
